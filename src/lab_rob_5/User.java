...
public class User extends UserDemo{
    ...
    public void blackFriday(double k){
        System.out.println("У чорну п'ятницю ігри зі знижкою ");
        System.out.println("Користувач зекономив: " + k);
    }

    public void blackFriday(){
        System.out.println("Знижок немає");
    }
}
